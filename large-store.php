...
<body>
	<content class="secciones">
		<div class="top top-large-store">
			<img src="assets/img/nuevas-fotos-1/titulo-large-store.png" alt="large-store" />
		</div>
		<div class="intro">
			<img src="assets/img/hr-estilo-home-recto.png" alt="divider" />
			<p class="parrafo-bajada"><b>TOPO CHICO IN THE LARGE STORE CHANNEL</b><br>
			In this section, you will learn how to activate Topo Chico Sparkling Mineral Water in the large store channel. Discover why, how, and where to execute the brand in large stores using a channel-led commercial strategy. </p>
		...
		<div id="cambio" class="listado listadogrid">
			<div id="prod" class="producto">
			    ...
			    <div>
					<p class="parrafo-producto icon-revert">LS order of entry:<img src="assets/img/iconos/pp_new.png" alt="icono de video"/></p>
				...
				<a href="https://topochicouniversity.com/materials/large-store/large-store-order-of-entry.pptx" target="_blank" rel="nofollow"><div class="btn-rojo animbtnhome">Download</div></a>
					<p class="download">< 6.28 MB >  Download</p>
				</div>
			</div>

			<div id="prod" class="producto">
			    <div>
					<p class="parrafo-producto icon-revert">LS Sell sheet General Markets: <img src="assets/img/iconos/word_new.png" alt="icono de video"/></p>
					<p class="parrafo-producto-1">Use this one-page, summarized resource to execute and activate Topo Chico successfully in Large Store General Markets.</p>
				</div>
				<div class="botones-productos">
				<a href="https://topochicouniversity.com/materials/large-store/sell-sheet-ls-general-market.pdf" target="_blank" rel="nofollow"><div class="btn-rojo animbtnhome">Learn More</div></a>
					<p class="download">< 825 KB >  Download</p>
				</div>
			</div>

			<div id="prod" class="producto">
			    <div>
					<p class="parrafo-producto icon-revert">LS Sell sheet Hispanic Outlets<img src="assets/img/iconos/word_new.png" alt="icono de video"/></p>
					<p class="parrafo-producto-1">Use this one-page, summarized resource to execute and activate Topo Chico successfully in Hispanic Outlets. </p>
				</div>
				<div class="botones-productos">
				<a href="https://topochicouniversity.com/materials/large-store/sell-sheet-ls-hispanic-ourtlets.pdf" target="_blank" rel="nofollow"><div class="btn-rojo animbtnhome">Learn More</div></a>
					<p class="download">< 805 KB >  Download</p>
				</div>
			</div>
			...
			<div id="prod" class="producto">
			    <div>
					<p class="parrafo-producto icon-revert">LS Strategy & Rules of Engagement: <img src="assets/img/iconos/pp_new.png" alt="icono de video"/></p>
					<p class="parrafo-producto-1">Learn about the brand strategy in the large store channel, including guardrails for best-in-class commercial execution.</p>
				</div>				
				<div class="botones-productos">
				<a href="https://topochicouniversity.com/materials/large-store/ls-strategy-and-rules-of-engagement.pptx" target="_blank" rel="nofollow"><div class="btn-rojo animbtnhome">Download</div></a>
					<p class="download">< 114 MB >  Download</p>
				</div>
			</div>
			...
			<div id="accordion">
				...
				<div style="padding-top: 20px;"class="card">
						...
						<div id="collapseThree" class="collapse" data-bs-parent="#accordion">
							<div class="card-body">
							<div class="botones-productos">
							            <a href="https://topochicouniversity.com/materials/large-store/tc-product-spec-sheets/twists/tch-mineral-water-twist-lime-12oz-24-units.pdf" target="_blank" rel="nofollow"><div class="btn-rojo animbtnhome">Learn More</div></a>
